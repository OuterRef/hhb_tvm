...
#ifndef DWCONV3X3S1_RELU
#define DWCONV3X3S1_RELU shl_c906_dwconv3x3s1_relu
#endif

#ifndef DWCONV3X3S2_RELU
#define DWCONV3X3S2_RELU shl_c906_dwconv3x3s2_relu
#endif
/*
...
int DWCONV3X3S1_RELU(struct csinn_tensor *input, struct csinn_tensor *output,
                struct csinn_tensor *kernel, struct csinn_tensor *bias,
                struct csinn_conv2d_params *params)
{
    float *input_data = (float *)input->data;
...
int DWCONV3X3S2_RELU(struct csinn_tensor *input, struct csinn_tensor *output,
                     struct csinn_tensor *kernel, struct csinn_tensor *bias,
                     struct csinn_conv2d_params *params)
{
    float *input_data = (float *)input->data;
