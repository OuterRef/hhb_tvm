...
#ifndef DWCONV5X5S1_RELU
#define DWCONV5X5S1_RELU shl_c906_dwconv5x5s1_relu
#endif

#ifndef DWCONV5X5S2_RELU
#define DWCONV5X5S2_RELU shl_c906_dwconv5x5s2_relu
#endif
...
int DWCONV5X5S1_RELU(struct csinn_tensor *input, struct csinn_tensor *output,
                     struct csinn_tensor *kernel, struct csinn_tensor *bias,
                     struct csinn_conv2d_params *params)
{
    float *input_data = (float *)input->data;
...
int DWCONV5X5S2_RELU(struct csinn_tensor *input, struct csinn_tensor *output,
                     struct csinn_tensor *kernel, struct csinn_tensor *bias,
                     struct csinn_conv2d_params *params)
{
    float *input_data = (float *)input->data;
