...
static void kernel_m1_fp16_fuse_relu(__fp16* dst, __fp16* sa, __fp16* sb, int m, int k, int n, int ldc,
                                     __fp16* bias)
{
    asm volatile(
        "vsetvli        zero, zero, e16, m1\n\t"  // set vl = 8
...
static void kernel_m2_fp16_fuse_relu(__fp16* dst, __fp16* sa, __fp16* sb, int m, int k, int n, int ldc,
                                     __fp16* bias)
{
    asm volatile(
        "vsetvli        zero, zero, e16, m1\n\t"  // set vl = 8
...
static void kernel_m4_fp16_fuse_relu(__fp16* dst, __fp16* sa, __fp16* sb, int m, int k, int n, int ldc,
                                     __fp16* bias)
{
    asm volatile(
        "vsetvli        zero, zero, e16, m1\n\t"  // set vl = 8
...
static void kernel_m8_fp16_1_fuse_relu(__fp16* dst, __fp16* sa, __fp16* sb, int m, int k, int n, int ldc,
                                       __fp16* bias)
{
    asm volatile(
        "vsetvli        zero, zero, e16, m1\n\t"  // set vl = 8
        ...
        "vfmax.vf          v26, v26, ft11\n\t"
        "vfmax.vf          v27, v27, ft11\n\t"
        "vfmax.vf          v28, v28, ft11\n\t"
        "vfmax.vf          v29, v29, ft11\n\t"
        "vfmax.vf          v30, v30, ft11\n\t"
        "vfmax.vf          v31, v31, ft11\n\t"
                                ...
                                int n, int ldc, __fp16* bias)
{
    ...
    for (int i = 0; i < mm; i += 8) {
        kernel_m8_fp16_1_fuse_relu(pc + i * ldc, pa + i * k, pb, m, k, n, ldc, bias_tmp + i);
    }
    ...
    switch (m - mm) {
        case 7:
            kernel_m4_fp16_fuse_relu(pc, pa, pb, m, k, n, ldc, bias_tmp);
            pc += 4 * ldc;
            pa += 4 * k;
            bias_tmp += 4;
            kernel_m2_fp16_fuse_relu(pc, pa, pb, m, k, n, ldc, bias_tmp);
            pc += 2 * ldc;
            pa += 2 * k;
            bias_tmp += 2;
            kernel_m1_fp16_fuse_relu(pc, pa, pb, m, k, n, ldc, bias_tmp);
            break;
