                            ...
                            int k, int n, int ldc)
{
    ...
    for (; i + 7 < m; i += 8) {
        ...
        for (; j + 15 < n; j += 16) {
            ...
            _acc0 = vfmax_vf_f16m2(_acc0, 0, vl);
            _acc1 = vfmax_vf_f16m2(_acc1, 0, vl);
            _acc2 = vfmax_vf_f16m2(_acc2, 0, vl);
            _acc3 = vfmax_vf_f16m2(_acc3, 0, vl);
            _acc4 = vfmax_vf_f16m2(_acc4, 0, vl);
            _acc5 = vfmax_vf_f16m2(_acc5, 0, vl);
            _acc6 = vfmax_vf_f16m2(_acc6, 0, vl);
            _acc7 = vfmax_vf_f16m2(_acc7, 0, vl);
        ...
        for (; j + 7 < n; j += 8) {
            ...
            _acc0 = vfmax_vf_f16m1(_acc0, 0, vl);
            _acc1 = vfmax_vf_f16m1(_acc1, 0, vl);
            _acc2 = vfmax_vf_f16m1(_acc2, 0, vl);
            _acc3 = vfmax_vf_f16m1(_acc3, 0, vl);
            _acc4 = vfmax_vf_f16m1(_acc4, 0, vl);
            _acc5 = vfmax_vf_f16m1(_acc5, 0, vl);
            _acc6 = vfmax_vf_f16m1(_acc6, 0, vl);
            _acc7 = vfmax_vf_f16m1(_acc7, 0, vl);
